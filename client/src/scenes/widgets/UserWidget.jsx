...
const UserWidget = ({ userId, picturePath }) => {
  ...
  // since there is an empty array, getUser() will be called, when the component is rendered for the first time
  useEffect(() => {
    getUser();
  }, []); //eslint-disable-line react-hooks/exhaustive-deps

  //   when there is no user, null will be returned, prevent erroring out
  if (!user) {
    return null;
  }
